...
class Helper
{
    ...
    {
        wp_register_style('ui-e-'.$name, UICORE_ASSETS . '/css/elements/'.$name.'.css',$deps,UICORE_VERSION);
    }
    static function register_widget_script($name,$deps=[])
    {
        wp_register_script('ui-e-'.$name, UICORE_ASSETS . '/js/elements/'.$name.'.js',$deps,UICORE_VERSION,true);
    }
