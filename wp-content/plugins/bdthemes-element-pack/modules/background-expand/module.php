...
class Module extends Element_Pack_Module_Base {
    ...
    public function register_controls($section, $args) {
     ...
     public function enqueue_scripts() {
        wp_enqueue_script('gsap', BDTEP_ASSETS_URL . 'vendor/js/gsap.min.js', [], '3.12.5', true);
        wp_enqueue_script('scroll-trigger', BDTEP_ASSETS_URL . 'vendor/js/ScrollTrigger.min.js', [], '3.12.5', true);
