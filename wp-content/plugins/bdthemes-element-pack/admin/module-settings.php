		...
		$settings_fields                                      = [
			...
			'element_pack_other_settings'   => [
				...
				[
					...
					'desc'  => __('Turn on this switcher to enable the Smooth Scroller Features, The Smooth Scroller feature enhances user experience by providing seamless, visually pleasing content navigation through animated transitions.<div class="bdt-text-bold bdt-text-warning bdt-text-small">Note: Have sticky element! you must select the element from Smooth Scroller inside "Site Settings" of Elementor Editor Page</div>', 'bdthemes-element-pack'),
					'type'  => 'start_group',
					'content_type' => 'new',
				],
