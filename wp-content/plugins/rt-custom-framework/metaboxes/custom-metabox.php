...
function rt_register_header_metabox() {
  ...
  /**
		...
		'tabs' => array(
            ...
            array(
                ...
                'fields' => array(
                    ...
                    'footer_socials_icon_hover_colors',
                    'footer_btn_bg_color',
                    'footer_socials_hover_bg_colors',
	...
	// Topbar Select
	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Select Top Bar', 'rs-framework' ),
		'desc'             => esc_html__( 'Select Top Bar to show on this page', 'rs-framework' ),
		'id'               => 'topbar_select',
		'type'             => 'select',
		'show_option_none' => 'Default',
		'options'          => array(
			'topbar1' => esc_html__( 'Top Bar One', 'rs-framework' ),
			'topbar2' => esc_html__( 'Top Bar two', 'rs-framework' ),
			'topbar3' => esc_html__( 'Top Bar Three', 'rs-framework' ),
			'topbar4' => esc_html__( 'Top Bar Four', 'rs-framework' ),
		),
	) );
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Feed Title Color', 'rs-framework' ),
		'desc'    => esc_html__( 'chosse  Color', 'rs-framework' ),
		'id'      => 'feed_color',		
		'type'    => 'colorpicker',
		'default' => '',
	) );
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Feed Link Color', 'rs-framework' ),
		'desc'    => esc_html__( 'chosse  Color', 'rs-framework' ),
		'id'      => 'feed_link_color',		
		'type'    => 'colorpicker',
		'default' => '',
	...
	// Humburger
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Hamburger Bg Color', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Hamburger Bg color', 'cmb2' ),
		'id'      => 'offcanvs_icon_bg',
		'type'    => 'colorpicker',
		'default' => '',
		'options' => array( 'alpha' => true )		
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Hamburger Dots Color', 'cmb2' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Hamburger Dots Hover Color', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Hamburger Dots Hover color', 'cmb2' ),
		'id'      => 'head_hamburger_hover_color',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Quote Button Border Radius', 'cmb2' ),		
		'id'      => 'quote_button_border_radius',
		'type'    => 'text_medium',
		'default' => '',		
	) );
	...
	$cmb_demo->add_field( array(
		...
		'show_option_none' => 'Default',
		'options'          => array(			
			'footer2' => esc_html__( 'Footer Style 2', 'rs-framework' ),
			'footer3' => esc_html__( 'Footer Style 3', 'rs-framework' ),						
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Footer Social Icon Hover Color', 'cmb2' ),
		'desc'    => esc_html__( 'Footer Social Icon Hover Color', 'cmb2' ),
		'id'      => 'footer_socials_icon_hover_colors',
		'type'    => 'colorpicker',
		'default' => '',		
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Footer Social Icon Hover Bg Color', 'cmb2' ),
		'desc'    => esc_html__( 'Footer Social Icon Hover Bg Color', 'cmb2' ),
		'id'      => 'footer_socials_hover_bg_colors',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Preloader Background', 'cmb2' ),
		'desc'    => esc_html__( 'select  background', 'cmb2' ),
		'id'      => 'preloader_bg',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Preloader Icon Color', 'cmb2' ),
		'desc'    => esc_html__( 'select  Color', 'cmb2' ),
		'id'      => 'preloader_icon_bg',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
