	 ...
	 */
        ...
        $this->add_control(
        	...
        	[
        		...
        		'default'     => '',				
        		'separator'   => 'before',
        		'condition' => ['services_style' => ['style6', 'style7']],
        ...
        $this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}}  .react-addon-services.services-style6 .services-part .shadow-text',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style6 .services-part .shadow-text' => 'color: {{VALUE}};',
		        ],
		         'separator'   => 'before',
        		'condition' => ['services_style' => ['style6', 'style7']],
		    ]
		...
		$this->add_control(
            'stroke_show_hide',
            [
                'label' => esc_html__( 'Stroke Enable', 'rtelements' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'no',
                'options' => [
		...
		$this->add_control(
			'before_icon_text',
			[
				'label' => esc_html__( 'Before Icon Text', 'rtelements' ),
		...
		$this->add_control(
			'title_prefix_icon',
			[
				'label'       => esc_html__( 'Services Title Icon', 'rtelements' ),
				'type'  => Controls_Manager::MEDIA,						
				'separator'   => 'before',
				'condition' => [
