<div class="react-addon-services services-<?php echo esc_attr( $settings['services_style'] ); ?>">
    <div class="services-part">
	    <div class="services-text">
            ...
            <?php if(!empty($settings['before_icon_text'])) : ?>
                <div class="before-icon-text">
                    <p <?php  echo $this->print_render_attribute_string( 'before_icon_text' ); ?>>  <?php echo $settings['before_icon_text'];?></p>	
                </div>		    		       
                <?php endif; ?>	
	    	...
	    	<?php if(!empty($settings['title'])){ ?>
		    	<div class="services-title">		    		
		    		...
		    		?>					    							    			
		    		<<?php echo esc_html($settings['title_tag']);?>  <?php  echo $this->print_render_attribute_string( 'title' ); ?>> <a href="<?php echo esc_url($settings['title_link']);?>" <?php echo wp_kses_post($link_open); ?> ><?php echo esc_html($settings['title']);?></a></<?php echo esc_html($settings['title_tag']);?>>
		    		<?php else: ?>
		    			<<?php echo esc_html($settings['title_tag']);?> <?php  echo $this->print_render_attribute_string( 'title' ); ?>><?php if(!empty($settings['title_prefix_icon'])) :?>
