...
class Reactheme_Elementor_Video_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'icon_bg',
			[
				'label' => esc_html__( 'Icon Background Color', 'pielements' ),
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Position Vertical', 'pielements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
                'range' => [
                    '%' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Position Horizontal', 'pielements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
                'range' => [
                    '%' => [
