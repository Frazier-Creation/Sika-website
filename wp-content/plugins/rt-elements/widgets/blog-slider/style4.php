<?php 
	...
	?>
	<div class="align-items-center no-gutter blog-item reactheme-blog-grid1 bsg-style-4 col-md-12">
           ...
           <?php if( !empty($settings['blog_meta_show_hide']) || !empty($settings['blog_avatar_show_hide'])){?>
            <ul class="blog-meta">
                <?php if(($settings['blog_meta_show_hide'] == 'yes') ){ ?>
                    ...
                    <li><i class="fal fa-calendar-alt blog-slider4-date"></i> <?php echo esc_html($full_date);?></li>
                    <?php } ?>
                <?php } ?>
                ...
                <?php } ?>
                    ...
                    <li>/ 
                        <?php $categories = get_the_category();
                            if ( ! empty( $categories ) ) {
                                echo '<a class="blog-slider4-cat blog-slider4-date" href="' . esc_url( get_category_link( $categories[0]->term_id ) ) . '"><b>' . esc_html( $categories[0]->name ) . '</b></a>';
                            }?>  
                    </li>
                    <?php } ?>
            </ul>
            ...
            <a href="<?php the_permalink();?>" class="read--more">Read More <i class="ml-2 fal fa-long-arrow-right"></i></a>
