...
class ReacTheme_Elementor_Blog_Slider_Widget extends \Elementor\Widget_Base {
 ...
 $this->end_controls_section();
        ...
        $this->add_responsive_control(
		    'section_content_spacing_padding',
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .reactheme-blog-grid1.blog-item .blog-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);  
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [                  
                    '{{WRAPPER}} .reactheme-blog-grid1.blog-item .blog-content' => 'background: {{VALUE}};',                   
         ...
         $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [                  
                    '{{WRAPPER}} .reactheme-blog-grid1.blog-item .blog-content .title a' => 'color: {{VALUE}};',                   
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .reactheme-blog-grid1.blog-item .blog-content .title a:hover' => 'color: {{VALUE}};',                    
                ],                
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .reactheme-blog-grid1.blog-item .cat_list ul li a' => 'color: {{VALUE}} !important;',                   
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .reactheme-blog-grid1.blog-item .cat_list ul li a:hover' => 'color: {{VALUE}} !important;',                    
                ],                
            ]
        ...
        $this->add_control(
            'category_color_bg',
            [
                'label' => esc_html__( 'Category Background Color', 'rtelements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .reactheme-blog-grid1.blog-item .cat_list ul li a' => 'background: {{VALUE}} !important;',                    
                ],                
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Category Top Gap', 'rtelements' ),
                'type' => Controls_Manager::SLIDER,
                'show_label' => true,
                'size_units' => [ 'px', '%' ],               
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .reactheme-blog-grid1.blog-item .cat_list ul li a' => 'top:{{SIZE}}{{UNIT}};',                    
                ],
            ]
        ); 
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Category Left Gap', 'rtelements' ),
                'type' => Controls_Manager::SLIDER,
                'show_label' => true,
                'size_units' => [ 'px', '%' ],               
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .reactheme-blog-grid1.blog-item .cat_list ul li a' => 'left:{{SIZE}}{{UNIT}};',                    
                ],
            ]
        ); 
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rt_widget_sliders .slick-next' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .rt_widget_sliders .slick-prev' => 'background: {{VALUE}};',
