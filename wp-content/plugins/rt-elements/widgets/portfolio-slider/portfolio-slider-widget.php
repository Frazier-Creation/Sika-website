...
class ReacTheme_Portfolio_Slider_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'button_text',
			[
				'label' => esc_html__( 'Read More Buttob Text', 'rtelements' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'Read More',
				'separator' => 'before',
			]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rt-portfolio-style5 .portfolio-item .item-img:before' => 'background: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rt_widget_sliders .slick-next, .rt_widget_sliders .slick-prev' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .rt_widget_sliders .slick-next, .rt_widget_sliders .slick-next' => 'background: {{VALUE}};',
