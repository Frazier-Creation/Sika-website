...
class ReacTheme_Elementor_Counter_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_border_color',
			[
				'label' => esc_html__( 'Title Border Color', 'rtelements' ),
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .counter-top-area.style3 .rs-counter-list .count-text .title' => 'border-color: {{VALUE}};',
				],
		...
		$this->add_control(
			'title_border_active_color',
			[
				'label' => esc_html__( 'Title Border Active Color', 'rtelements' ),
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .counter-top-area.style3 .rs-counter-list .count-text .title:before' => 'background: {{VALUE}};',
				],
				'condition' => [ 'style' => 'style3' ]
			]
		);
		$this->add_control(
		    'title_border_active_width',
		    [
		        'label' => esc_html__( 'Title Border Active Width', 'rtelements' ),
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .counter-top-area.style3 .rs-counter-list .count-text .title:before' => 'width: {{SIZE}}{{UNIT}};',
		        ],
				'condition' => [ 'style' => 'style3' ]
		    ]
		);
