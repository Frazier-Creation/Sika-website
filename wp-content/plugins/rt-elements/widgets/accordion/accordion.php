 ...
 protected function register_controls() {
       ...
       $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .accordion.style2 .cart-button-rt' => 'color: {{VALUE}} !important',
                    '{{WRAPPER}} .cart-button-rt' => 'color: {{VALUE}} !important',
                ],                
            ]
        );
        ...
        <div class="accordion <?php echo $settings['accordion_style'];?>" id="accordionExample<?php echo $unique;?>">
            ...
            <div class="rt-cart">
              <div class="rt-card-header">
                <h2 class="mb-0">
                  <button class="btn btn-link btn-block cart-button-rt text-left <?php echo $col; ?>" aria-expanded="true" aria-controls="collapse<?php echo $x; ?>" type="button" data-toggle="collapse" data-target="#collapse<?php echo $x; ?>">
              ...
              <div id="collapse<?php echo $x; ?>" class="collapse"  data-parent="#accordionExample<?php echo $unique;?>">
                <div class="card-body">
