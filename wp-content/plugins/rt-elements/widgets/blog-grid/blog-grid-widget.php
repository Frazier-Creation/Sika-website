	...
	protected function register_controls() {		
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .reactheme-blog-grid .blog-item .blog-content .cat_list ul li a' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .reactheme-blog-grid .blog-item .cat_list ul li a' => 'background: {{VALUE}};',
                ], 
                'condition' => [
                    'blog_cat_show_hide' => 'yes',
                ]               
