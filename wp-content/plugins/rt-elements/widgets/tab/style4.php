<div class="rstab-main rstab-style-4 <?php echo esc_attr($settings['type']); ?> <?php echo esc_attr($settings['tabs_item_width']); ?>"> 
    <ul  class="nav nav-nav-tabs <?php echo esc_attr($settings['tab_design']);?> <?php echo esc_attr($settings['tab_icon_position']);?>">
        ...
        foreach ( $tabs as $index => $item ) :
            ...
            $titleimg    = !empty($item['selected_image']['url']) ? '<div class="icon--image"><img src="'. $item['selected_image']['url']. '" /></div>' : '';
            ?>
            <li class="nav-item">
                <a class="nav-link <?php echo esc_attr($active_tab); ?>" data-toggle="tab" href="#a<?php echo esc_html($x);?><?php echo esc_html( $unique );?>">
