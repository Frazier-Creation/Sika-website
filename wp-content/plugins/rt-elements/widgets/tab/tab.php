...
class Reactheme_Tab_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'before_content_image',
            [
                'label' => esc_html__( 'Before Content Image', 'rtelements' ),
        ...
        $this->add_control(
            'after_content_image',
            [
                'label' => esc_html__( 'After Content Image', 'rtelements' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
            ]
        );    
    ...
    protected function render() {
        ...
        }elseif('style3' == $settings['tab_style']){
            require plugin_dir_path(__FILE__)."/style3.php";
        }elseif('style4' == $settings['tab_style']){
