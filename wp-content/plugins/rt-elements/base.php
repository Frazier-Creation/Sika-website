...
final class RTelements_Elementor_Extension {
	...
	public function init_widgets() {
		...
		//require_once( __DIR__ . '/widgets/services-slider/services-slider.php' );
		...
		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Heading_Widget() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Testimonial_Slider_Widget() );			
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Image_Showcase_Widget() );	
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Testimonial_Slider_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \back_pro_timeline_Showcase_Widget() );		
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Pro_Features_List_Widget() );	
		//\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Service_slider_Widget() );	
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Pielemetns_Elementor_thumbnail_slider_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Pro_blog_category_slider_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Pro_Instagram_Widget());
