<?php
    if ( class_exists( 'WooCommerce' ) && is_shop() || class_exists( 'WooCommerce' ) && is_product_tag()  || class_exists( 'WooCommerce' ) && is_product_category()  ) {
        ...
        $footer_style            = get_post_meta($finanix_shop_id,'footer_style', true);
        $footer_bg             = get_post_meta($finanix_shop_id,'footer_bg', true);
        $footer_bg_img         = get_post_meta($finanix_shop_id,'footer_bg_img', true);
        $hide_footer_subscribe = get_post_meta($finanix_shop_id, 'hide_footer_subscribe', true);
        $newsletter_bg_img     = get_post_meta($finanix_shop_id, 'newsletter_bg_img', true);
        $copyright_bg          = get_post_meta($finanix_shop_id,'copyright_bg', true);
        $copyright_trans       = get_post_meta($finanix_shop_id,'copyright_trans', true);
        $bg_pos                = get_post_meta($finanix_shop_id,'footer_bg_position', true);
        $bg_repeat             = get_post_meta($finanix_shop_id,'footer_bg_repeat', true);
        $bg_size               = get_post_meta($finanix_shop_id,'footer_bg_size', true);
        $copy_space            = get_post_meta($finanix_shop_id,'copyright_padding', true);
