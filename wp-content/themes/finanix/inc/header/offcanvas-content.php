...
if(!empty($finanix_option['facebook']) || !empty($finanix_option['twitter']) || !empty($finanix_option['rss']) || !empty($finanix_option['pinterest']) || !empty($finanix_option['google']) || !empty($finanix_option['instagram']) || !empty($finanix_option['vimeo']) || !empty($finanix_option['tumblr']) ||  !empty($finanix_option['youtube'])){
?>
