...
if(!empty($finanix_option['enable_global'])){	
    $topbar_style    =  !empty($finanix_option['topbar_layout']) ? $finanix_option['topbar_layout'] : '';
	...
	elseif(!empty($finanix_option['topbar_layout'])){	   
		$topbar_style = $finanix_option['topbar_layout'];
		if($topbar_style == 'style1'){		 
			get_template_part('inc/header/top-head/top-head-one'); 		
		}
		if($topbar_style == 'style2'){		 
